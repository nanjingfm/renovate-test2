...
FROM docker-mirrors.alauda.cn/library/eclipse-temurin:17-jdk-jammy as builder
...
# renovate: datasource=maven depName=net.minidev/json-smart
ARG JSON_SMART_VERSION=2.5.0
